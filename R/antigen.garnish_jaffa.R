## ---- garnish_jaffa
#' Derive mutant peptides from JAFFA gene fusion output.
#'
#' Derive mutant fusion peptides for neoepitope predictions from JAFFA `fasta` and `results.csv` output for input to `garnish_predictions`.
#'
