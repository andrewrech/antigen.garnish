  ...
  dt %>%
    ...
    testthat::expect_equal(
      ...
      structure(list(ANN = c(
        ...
        "upstream_gene_variant", "upstream_gene_variant", "missense_variant",
        "missense_variant", "non_coding_transcript_exon_variant"
      ), putative_impact = c(
        "MODERATE",
        "MODIFIER", "MODIFIER", "MODIFIER", "MODERATE", "MODERATE", "MODIFIER"
      ), gene = c(
        "Phf13", "Thap3", "Thap3", "Thap3", "Thnsl2", "Thnsl2",
        "Thnsl2"
      ), ensembl_gene_id = c(
        "ENSMUSG00000047777.1", "ENSMUSG00000039759.1",
        "ENSMUSG00000039759.1", "ENSMUSG00000039759.1", "ENSMUSG00000054474.1",
        "ENSMUSG00000054474.1", "ENSMUSG00000054474"
      ), feature_type = c(
        "transcript",
        ...
        "protein_coding",
        "protein_coding", "protein_coding", "retained_intron", "protein_coding",
        ...
        "c.431A>G",
        "c.-3347A>G", "c.-3347A>G", "n.-3323A>G", "c.332C>T", "c.332C>T",
        "n.150C>T"
      ), protein_change = c(
