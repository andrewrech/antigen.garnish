testthat::test_that("get_vcf_snpeff_dt", {
  ...
  dt[, .SD, .SDcols = c(
    "effect_type", "ensembl_transcript_id",
      ...
      structure(
        list(
          ...
          ensembl_transcript_id = c(
            ...
            "ENSMUST00000036680.7",
            "ENSMUST00000105665.1",
            "ENSMUST00000146471.1",
            "ENSMUST00000074241.8",
            "ENSMUST00000160918.7",
            "ENSMUST00000170455.1"
          ),
          ensembl_gene_id = c(
            "ENSMUSG00000047777.1",
            "ENSMUSG00000039759.1",
            "ENSMUSG00000039759.1",
            "ENSMUSG00000039759.1",
            "ENSMUSG00000054474.1",
            "ENSMUSG00000054474.1",
            "ENSMUSG00000054474.1"
          ),
          protein_change = c(
